    ...
    const response = await fetch("https://ai.gateway.lovable.dev/v1/chat/completions", {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: "system",
            content: `You are a helpful, multilingual support assistant for RE:TOUR, a virtual tour rendering platform.
...
Remember: Respond in the user's language. A valid question about the site in Hebrew deserves a Hebrew answer about the site.`
    ...
    const aiResponse = data.choices?.[0]?.message?.content || "I can help you navigate RE:TOUR. What would you like to know?";
